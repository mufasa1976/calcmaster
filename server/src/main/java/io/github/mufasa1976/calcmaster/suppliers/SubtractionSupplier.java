  ...
  private long[] getOperandsWithTransgression() {
    ...
    do {
      ...
      if (bound > 0) {
        ...
        } else if (operand2[operand2.length - digit - 1] + remainderOfPreviousDigit < 10) {
          operand1[operand1.length - digit - 1] = random.nextInt(10 - operand2[operand2.length - digit - 1] - remainderOfPreviousDigit);
        }
      }
